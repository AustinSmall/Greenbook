...
function TextColumns() {
  return (
    <div className=" bg-vintage bg-no-repeat bg-cover flex-shrink mx-full columns-3  p-6 sm:columns-4 ">
        <div> 
        ...
        <div className='py-5'>
            <h2 className='py-1.5'>K</h2>
        </div>

        <div className='py-5'>
            <h2 className='py-1.5'> L</h2>
        </div>
        ...
        <div className='py-5'>
            <h2 className='py-1.5'>N</h2>
        </div>

        <div className='py-5'>
            <h2 className='py-1.5'>O</h2>
        </div>
        ...
        <div className='py-5'>
            <h2 className='py-1.5'>X</h2>
        </div>

        <div className='py-5'>
            <h2 className='py-1.5'>Y</h2>
        </div>

        <div className='py-5'>
            <h2 className='py-1.5'>Z</h2>
        </div>
